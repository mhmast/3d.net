namespace _3DNet.Math
{
    ...
    {
        public static Quaternion Identity => ( 0f, 0, 0, 1);

        public Quaternion(params Scalar[] values) : base(values)
        {
        }
        ...
        public static Quaternion CreateFromAxisAngle(Vector3F axis, float angle)
        {
            ...
            return (axis.X * s, axis.Y * s, axis.Y * s, c);
        }
        ...
        public Quaternion Concatenate(Quaternion other)
        {
            ...
            return (q1x * q2w + q2x * q1w + cx, q1y * q2w + q2y * q1w + cy, q1z * q2w + q2z * q1w + cz, q1w * q2w - dot);
        }
        ...
        public static implicit operator Quaternion((float, float, float, float) data) => new Quaternion(data.Item1,data.Item2,data.Item3,data.Item4);
    }
}
